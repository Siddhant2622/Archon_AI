  ...
  try {
    ...
    if (error instanceof SyntaxError) {
      ...
      return {
        ...
        sections: {
          architecture: { score: 50, reasons: [], improvements: [] },
          performance: { score: 50, reasons: [], improvements: [] },
          security: { score: 50, reasons: [], improvements: [] },
          codeQuality: { score: 50, reasons: [], improvements: [] },
          database: { score: 50, reasons: [], improvements: [] },
          api: { score: 50, reasons: [], improvements: [] },
          uiux: { score: 50, reasons: [], improvements: [] },
          aiWorkflow: { score: 50, reasons: [], improvements: [] },
        },
        rootCauseTraces: [],
        dependencyGraph: [],
      } as AnalysisResult;
